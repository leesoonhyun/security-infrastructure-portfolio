...
| TENsion 최종자료 → Project 03·PPT | 보고서와 기여문서 요약, 문장 다듬기, 기존 PPT 디자인을 유지한 확장 작업 | 개인 책임 범위와 팀 집계값 해석, HTTP 응답·로그 근거 확인, 전체 슬라이드 시각 검수 | [Project 03](projects/03-tension-estmall-security-project.md), 15장 포트폴리오 PPT |
